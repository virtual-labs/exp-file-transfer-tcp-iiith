  ...
  function Q(f, T, O, z, Z) {
    ...
    if (lt(f))
      for (var et = 0; et < f.length; et++)
        (z = f[et]), (X = ut + q(z, et)), (Y += Q(z, T, O, X, Z));
    else if (((et = W(f)), typeof et == "function"))
      for (f = et.call(f), et = 0; !(z = f.next()).done; )
        (z = z.value), (X = ut + q(z, et++)), (Y += Q(z, T, O, X, Z));
    else if (X === "object") {
        ...
        function lt(r) {
          for (var _ = H(E); _ !== null; ) {
            if (_.callback === null) y(E);
              ...
              y(E), (_.sortIndex = _.expirationTime), p(j, _);
            else break;
            _ = H(E);
          }
        }
  ...
  return (
    ...
    (Pt.flushSync = function (j) {
      var E = K.T,
        B = y.p;
      try {
        if (((K.T = null), (y.p = 2), j)) return j();
      } finally {
        (K.T = E), (y.p = B), y.d.f();
      }
    }),
    (Pt.preconnect = function (j, E) {
      typeof j == "string" &&
        (E
          ? ((E = E.crossOrigin),
            (E =
    ...
    (Pt.preinit = function (j, E) {
      if (typeof j == "string" && E && typeof E.as == "string") {
        ...
        B === "style"
          ? y.d.S(j, typeof E.precedence == "string" ? E.precedence : void 0, {
              crossOrigin: tt,
              integrity: W,
              fetchPriority: Et,
            })
    ...
    (Pt.unstable_batchedUpdates = function (j, E) {
      return j(E);
    }),
    (Pt.useFormState = function (j, E, B) {
      return K.H.useFormState(j, E, B);
    }),
...
` +
  ...
  var fl = typeof Object.is == "function" ? Object.is : j0;
  function Qa(t, l) {
    if (fl(t, l)) return !0;
    if (
      typeof t != "object" ||
  ...
  var q0 = Hl && "documentMode" in document && 11 >= document.documentMode,
    la = null,
    Ec = null,
    wa = null,
    Ac = !1;
  ...
  function Sl(t, l) {
    if (typeof t == "object" && t !== null) {
      ...
      return e !== void 0
        ? e
        : ((l = { value: t, source: l, stack: qf(l) }), Ts.set(t, l), l);
    }
    return { value: t, source: l, stack: qf(l) };
  }
  var gl = [],
    aa = 0,
    _c = 0;
  ...
  function Za(t) {
    ...
    if (
      ...
      l === 27
        ? ((l = jt), ve(t.type) ? ((t = Fi), (Fi = null), (jt = t)) : (jt = l))
        : (jt = tl ? Ol(t.stateNode.nextSibling) : null);
    return !0;
  }
  function La() {
    (jt = tl = null), (gt = !1);
  ...
  function Hs(t, l) {
    var e = t.callbacks;
    if (e !== null)
      for (t.callbacks = null, t = 0; t < e.length; t++) qs(e[t], l);
  }
  var oa = T(null),
    un = T(0);
  function Bs(t, l) {
      ...
      if (e !== null) {
        t: {
          ...
          if (gt) {
            if (jt) {
              l: {
                for (var u = jt, n = Rl; u.nodeType !== 8; ) {
                  if (!n) {
                    u = null;
                    break l;
                  }
              ...
              if (u) {
                (jt = Ol(u.nextSibling)), (a = u.data === "F!");
                break t;
              }
            }
            Ce(a);
  ...
  function _o(t) {
    ...
    function S(d, o, v, N) {
      ...
      if (typeof v == "object" && v !== null) {
        ...
        if (Q(v) || q(v)) return G !== null ? null : A(d, o, v, N, null);
    ...
    function g(d, o, v, N, G) {
      ...
      if (typeof N == "object" && N !== null) {
        ...
        if (Q(N) || q(N)) return (d = d.get(v) || null), A(o, d, N, G, null);
    ...
    function Dt(d, o, v, N) {
      if (
        ...
        if (q(v)) {
          if (((G = q(v)), typeof G != "function")) throw Error(y(150));
    ...
    if (
      ...
      if (
        ...
        switch (e.tag) {
          case 13:
            return (
              zl === null ? Ci() : e.alternate === null && qt === 0 && (qt = 3),
              (e.flags &= -257),
              (e.flags |= 65536),
              (e.lanes = u),
              a === Yc
    ...
    if (
      ...
      if (n)
        ...
        if (
          ...
          throw ((s.retryLane = a), ua(t, a), hl(c, t, a), qo);
          ...
          t === null
            ? (e = Fr(l.type, null, l.pendingProps, null))
              ...
              : gt ||
                ((e = l.type),
                (t = l.pendingProps),
                (a = jn(Y.current).createElement(e)),
                (a[Ft] = l),
                (a[ll] = t),
                Jt(a, e, t),
                Qt(a),
      ...
      case 27:
        return (
          ...
          t === null &&
            ...
            (Rl = !0),
            (u = jt),
            ve(l.type) ? ((Fi = u), (jt = Ol(a.firstChild))) : (jt = u)),
        ...
        return (
          t === null &&
            ...
            ((t = e = jt) &&
              ...
              e !== null
                ? ((l.stateNode = e), (tl = l), (jt = null), (t = !0))
                : (t = !1)),
            t || Ce(l)),
          null
        );
        ...
        if (t && l.stateNode != null) t.memoizedProps !== a && Ll(l);
          ...
          if (((t = Y.current), Za(l))) {
            ...
            (t[Ft] = l),
              ...
              t || Ce(l);
          } else (t = jn(t).createTextNode(a)), (t[Ft] = l), (l.stateNode = t);
        }
        return Ct(l), null;
      case 13:
        if (
  ...
  function cr(t, l) {
    ...
    switch (t.tag) {
      ...
      case 4:
        (a = Ml),
          (Ml = qn(t.stateNode.containerInfo)),
          ol(l, t),
          rl(t),
          (Ml = a);
        break;
  ...
  function sr(t) {
    switch (t.tag) {
      ...
      case 4:
        var l = Ml;
        (Ml = qn(t.stateNode.containerInfo)), Sa(t), (Ml = l);
        break;
      case 22:
        t.memoizedState === null &&
          ((l = t.alternate),
      ...
      if (u === 0) {
        ...
        if (u === 2) {
          ...
          if (c !== 0) {
            ...
            t: {
              ...
              if ((s && (ba(i, c).flags |= 256), (c = ji(i, c, !1)), c !== 2)) {
                if (Mi && !s) {
        ...
        t: {
          ...
          if ((l & 62914560) === l && ((u = Ri + 300 - $t()), 10 < u)) {
            if ((he(a, l, bl, !oe), qu(a, 0, !0) !== 0)) break t;
            a.timeoutHandle = Zr(
  ...
  function xi() {
    if (dt !== null) {
      ...
      else (t = dt), (Kl = je = null), Jc(t), (ha = null), (nu = 0), (t = dt);
      ...
      l === $a || l === en
        ...
        : (bt =
            l === qo
              ...
              : 1),
      (dl = l),
      dt === null && ((qt = 1), gn(t, Sl(l, t.current)));
  }
  function gr() {
    var t = r.H;
  ...
  function Na(t, l, e, a) {
    (Kl = je = null), Jc(l), (ha = null), (nu = 0);
    var u = l.return;
    try {
      if (P0(t, u, l, e, ht)) {
        (qt = 1), gn(t, Sl(e, t.current)), (dt = null);
        return;
      }
    } catch (n) {
  ...
  function ry(t, l, e) {
    ...
    a !== null && a.delete(l),
      ...
      pt === t &&
        (ht & e) === e &&
        (qt === 4 || (qt === 3 && (ht & 62914560) === ht && 300 > $t() - Ri)
          ? (At & 2) === 0 && ba(t, 0)
          : (Oi |= e),
        Ta === ht && (Ta = 0)),
      xl(t);
  ...
  function Gr(t, l, e, a, u) {
    for (var n = l._reactName, c = []; e !== null && e !== a; ) {
      ...
      (i !== 5 && i !== 26 && i !== 27) ||
        ...
        ((s = m),
        u
          ? ((m = qa(e, n)), m != null && c.unshift(Su(e, m, s)))
          : u || ((m = qa(e, n)), m != null && c.push(Su(e, m, s)))),
        (e = e.return);
    }
...
`
  ...
  var Jl = _.d;
  _.d = { f: Uy, r: xy, D: Cy, C: jy, L: qy, m: Hy, X: Yy, S: By, M: Gy };
  function Uy() {
    var t = Jl.f(),
      l = On();
    return t || l;
      ...
      children: [
        ...
        h.jsxs("div", {
          ...
          children: [
            ...
            h.jsx("span", { className: "value timer", children: j() }),
          ],
        }),
      ],
    });
...
function yh() {
  ...
  const x = (q) => C((J) => [...J, q]),
    Nt = (q, J) => {
      p((k) => k.map((Q) => (Q.id === q ? { ...Q, [J]: !Q[J] } : Q)));
    };
  D.useEffect(() => {
    (V.current = new Worker("./sender.worker.js")),
      (lt.current = new Worker("./receiver.worker.js"));
    const q = { windowSize: vf, totalPackets: gf, timeoutDuration: oh };
    return (
      V.current.postMessage({ type: "INIT", payload: q }),
  ...
  const ft = (q) => {
      const k = !H.current.find((r) => r.id === q.seq).packetWillSucceed,
        Q = `${q.seq}-${Date.now()}`;
      p((r) => r.map((_) => (_.id === q.seq ? { ..._, status: "sent" } : _))),
        x(`(Network): Sending Packet ${q.seq}...`),
        K((r) => [
          ...r,
          {
            key: Q,
        ...
        setTimeout(() => {
          k
            ? x(`(Network): 🔴 Packet ${q.seq} was lost (manual setting)!`)
            : lt.current.postMessage({ type: "RECEIVE_PACKET", packet: q }),
            K((r) => r.filter((_) => _.key !== Q));
        }, _d);
    },
    _t = (q) => {
      const k = !H.current.find((r) => r.id === q).ackWillSucceed,
        Q = `ack-${q}-${Date.now()}`;
      x(`(Network): Sending ACK ${q}...`),
        K((r) => [
          ...r,
          {
            key: Q,
        ...
        setTimeout(() => {
          k
            ? x(`(Network): 🔴 ACK ${q} was lost (manual setting)!`)
            : (x(`(Sender): 🟢 ACK ${q} received successfully.`),
              p((r) =>
                r.map((_) => (_.id <= q ? { ..._, status: "acked" } : _))
              ),
...
function Sh() {
  ...
  D.useEffect(() => {
    ...
    const q = { totalPackets: Tf, timeoutDuration: hh };
    return (
      V.current.postMessage({ type: "INIT", payload: q }),
      lt.current.postMessage({ type: "INIT" }),
      (V.current.onmessage = (J) => {
        ...
        (J.current.onmessage = (Y) => {
          ...
          nt && Q(nt),
            ut === "STATE_UPDATE" &&
              ...
              $l &&
                $l !== Ut &&
                (alert("AIMD Phase Complete! Starting TCP Closure."), q($l))),
            ut === "SEND_PACKET" && R(et),
            ut === "TIMER_TICK" && it(Ae),
            ut === "TIMER_STOP" && it(null),
            ut === "TIMEOUT_EVENT" && it("TIMEOUT!");
